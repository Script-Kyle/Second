...
AutoFarm:AddSwitch("Fast Strenght", function(state)
...
local switch = PackFarm:AddSwitch("Fast Rebirth", function(state) autoRebirth = state if state then task.spawn(function() local c = game:GetService("Players").LocalPlayer local a = game:GetService("ReplicatedStorage")
...
function unequipAllPets()
        ...
        while autoRebirth do
            ...
            while c.leaderstats.Strength.Value < w do
                for _ = 1, 10 do  -- Fire 10 reps per frame
            ...
            if z and z:FindFirstChild("interactSeat") then
                ...
                repeat task.wait(0.05) interact() until c.Character.Humanoid.Sit
            end
