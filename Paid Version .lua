...
local webhookUrl = "https://discord.com/api/webhooks/1349371863519858770/WnFbDs_ITL12wjBqTGQkaLytfoC3H1KPrrVIzjVjq2upegIUtA-lbKBMHRj6Z44vYXRv"
...
local whitelist = {
    ...
    [8849111876] = true,
    [4343698759] = true,
    [9475902409] = true, -- Added as requested
    [2880241404] = true, -- New
    [5403396909] = true, -- New (and whitelisted as you requested)
}
 
local player = game.Players.LocalPlayer
if not whitelist[player.UserId] then
    player:Kick("Message From Akimbo(UA): Huy putangina ka magbayad kamuna sakin")
    return
end
...
local window = library:AddWindow("Akimbo|Paid Version", {
...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/EpicDeevv/Private-Scripts/refs/heads/main/yhjjjtj", true))()
local window = library:AddWindow("Gifting System", {
	main_color = Color3.fromRGB(0, 0, 255),
...
-- 🧍 PLAYER DROPDOWN
-----------------------------------------------------
local playerDropdown = GiftTab:AddDropdown("Select Player", function(selectedDisplayName)
	for _, plr in ipairs(Players:GetPlayers()) do
		if plr.DisplayName == selectedDisplayName then
			selectedPlayer = plr
			break
...
-- 🥚 ITEM DROPDOWN
-----------------------------------------------------
local itemDropdown = GiftTab:AddDropdown("Select Item to Gift", function(text)
	selectedItem = text
end)
...
-- 🔢 AMOUNT INPUT
-----------------------------------------------------
GiftTab:AddTextBox("Amount to Gift", function(text)
...
-----------------------------------------------------
local giftButton
giftButton = GiftTab:AddButton("Start/Stop Gifting", function()
	...
	-- Toggle gifting
	gifting = not gifting
	giftButton:SetText(gifting and "Stop/stop Gifting" or "Start/Stop Gifting")
...
infoTab:Show()
infoTab:AddLabel("made by Akimbo").TextSize = 20
infoTab:AddLabel("Official FaceBook:Kyle Mizusbino").TextSize = 20
infoTab:AddButton("Copy Facebook link", function()
    local link = "https://www.facebook.com/share/17hxw2cGvs/"
...
infoTab:AddLabel("")
wLabel = infoTab:AddLabel("Akimbo Paid Version V1")
wLabel.TextSize = 30
