...
-- Farming function (runs in a thread)
    ...
    task.spawn(function()
        while isFarmingStrength do
            ...
            if currentPing > 2000 then
                ...
                -- Premium & Normal players same reps (your script)
                local repsToDo = 17
...
-- UI Switch
local strengthFarmSwitch = PackFarm:AddSwitch("Fast Strength", function(state)
    isFarmingStrength = state
